...
export class InitialScheme1717317974122 implements MigrationInterface {
  name = "InitialScheme1717317974122";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "locations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "latitude" integer NOT NULL, "longitude" integer NOT NULL, CONSTRAINT "PK_7cc1c9e3853b94816c094825e74" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "users_locations" ("user_id" uuid NOT NULL, "location_id" uuid NOT NULL, "frequency" "public"."users_locations_frequency_enum" NOT NULL DEFAULT 'daily', "lastSent" date NOT NULL, CONSTRAINT "PK_ef032906be6d0a55ab892fcb88a" PRIMARY KEY ("user_id", "location_id"))`
    );
    await queryRunner.query(
